...
In this section, we describe how we go from an unstructured text representation of a domain to an interpretable representation composed of distinct properties. 
