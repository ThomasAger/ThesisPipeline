...
The bag-of-words (BOW)  assigns a value to each word based on its number of occurrences in the document. For example, a short document like "there was a dog, and a man, and the man, and the dog" would be translated into word frequencies "there: 1, was: 1, a: 2, and: 3, the: 2, man: 2, dog: 2". This representation is simple,  ignores word context, grammar and punctuation but is highly effective when using a large amount of unstructured text documents.  %CITE HERE 
