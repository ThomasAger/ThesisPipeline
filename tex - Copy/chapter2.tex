...
PCA is a dimensionality reduction method that takes features e.g. bag-of-words as input and produces a vector space of a specified size as a result. It is non-parametric and linear, and the dimensions that it produces are ordered by importance. 
