...
\hmark{In Table \ref{quan-freq-table} the average frequency of the clusters in each layer is shown for a variety of thresholds. Following the qualitative observations in Section \ref{auto-encoder-qual}, it is clear that as the auto-encoder layers get deeper, the frequency of the terms that are well modelled goes up. In conclusion, the stacked denoising auto-encoder models increasingly frequent terms.}
