...
\section{Quantitative Evaluation of Auto-encoders}

To evaluate if it is possible to obtain semantic properties from the hidden layers of stacked denoising auto-encoders, the experiment described in 
