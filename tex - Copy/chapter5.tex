...
\begin{landscape}
	\begin{table}[]
		...
		\centering
\begin{tabular}{llll}
	\textbf{Newsgroups}               & Unsupervised Embedding                                     & NNET-B                                                               & NNET-U  \\
	\toprule
...
\begin{landscape}
	...
	\begin{table}[]
		...
		\begin{tabular}{lp{7cm}p{7cm}p{7cm}}
			\textbf{Movies}      & Unsupervised Embedding                                                       & NNET-B                                                           & NNET-U                                                           \\
			\toprule
